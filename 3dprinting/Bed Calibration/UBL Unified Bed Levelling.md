...
3. Set Travel Limits
	...
	7. Ex. My probe is 23mm offset from nozzle. Nozzle can only get to -16mm in X axis. Therefore 23mm - 16mm is the furthest I can probe on my X axis. X/Y Probe offsets + Mesh border needs to be within travel limits for it to be able to probe all points
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc0NzcyNDUwOSwtMTU0ODg5MjY2MSwxND
